...
describe('calculating the correct ending date', () => {
    ...
    it('should work even when the week ends in the next month', () => {
    ...
    it('should work even when the sliding month ends in the next calendar month', () => {
